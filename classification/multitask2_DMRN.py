# -*- coding: utf-8 -*-
"""
Created on Tue Mar 17 16:11:02 2020
...
def dataload2(dir):
    setname = dir.split('/')[-1] + '_vio&aro_expansion.npy'
    setpath = os.path.join(dir,setname)
    #setpath = dir +'_set.npy'
    labelname1 = dir.split('/')[-1] + '_vio&aro_expansion_violence.npy'
    labelpath1 = os.path.join(dir,labelname1)
    #labelpath = dir + '_violence.npy'
    
    labelname2 = dir.split('/')[-1] + '_vio&aro_expansion_arousalClass.npy'
    labelpath2 = os.path.join(dir,labelname2)
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if test_map >= a:
            torch.save(model1,'./multi/DMRNvio+aro_vio.pkl')
            print('save violence model!')
            a = test_map
            
        if valence_test_acc*100.0/len(testset) >= b:
            torch.save(model2,'./multi/DMRNvio+aro_aro.pkl')
